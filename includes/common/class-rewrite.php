...
if ( ! class_exists( 'cp\common\Rewrite' ) ) {
	...
	class Rewrite {
		...
		public function reset_rules() {
			CP()->options()->update( 'flush_rewrite_rules', true );
		}
		...
		public function maybe_flush_rewrite_rules() {
			$flush_exists = CP()->options()->get( 'flush_rewrite_rules' );

			if ( $flush_exists ) {
				flush_rewrite_rules( false );
				CP()->options()->delete( 'flush_rewrite_rules' );
			}
		}
	}
}
